...
const ko: BusinessCopy = {
  ...
  whatWeDo: {
    eyebrow: "What We Do",
    title: "브랜드의 한국 진출, 하나의 팀이 끝까지",
    lead: "소싱부터 통관, 물류, 유통, 컨설팅까지 네 개의 축으로 운영합니다.",
    cards: [
      { key: "globe", title: "Global Sourcing (글로벌 소싱)", body: "현지 네트워크를 통해 브랜드를 직접 검증하고, 한국 시장에 맞는 라인업을 선별합니다." },
      { key: "truck", title: "원스톱 국제 물류 및 특송", body: "항공·해상·내륙 복합운송과 국제 특송을 단일 창구에서 관리합니다." },
      { key: "store", title: "온·오프라인 유통 / 판매", body: "백화점·마트·편의점부터 오픈마켓·버티컬 커머스까지 채널을 설계하고 운영합니다." },
      { key: "chart", title: "F&B 수입대행 및 컨설팅", body: "수입 계약, 인허가, 가격 구조, 마케팅까지 전담 컨설턴트가 함께합니다." },
    ],
  },
  trade: {
